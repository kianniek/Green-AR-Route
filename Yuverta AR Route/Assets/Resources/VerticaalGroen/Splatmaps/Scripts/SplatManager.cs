...
public class SplatManager : MonoBehaviour
{
    ...
    [SerializeField] public LightmapData lightmapData;

    [SerializeField] public LightmapSettings lightmapSettings;
    ...
    void Start()
    {
        ...
        splatTex.name = "SplatTexRenderTexture";
        splatTex.Create();
        splatTexAlt = new RenderTexture(sizeX, sizeY, 0, RenderTextureFormat.ARGB32, RenderTextureReadWrite.Linear);
        splatTexAlt.name = "SplatTexAltRenderTexture";
        splatTexAlt.Create();
        worldPosTex = new RenderTexture(sizeX, sizeY, 0, RenderTextureFormat.ARGBFloat, RenderTextureReadWrite.Linear);
        worldPosTex.name = "WorldPosTexRenderTexture";
        worldPosTex.Create();
        worldPosTexTemp =
            new RenderTexture(sizeX, sizeY, 0, RenderTextureFormat.ARGBFloat, RenderTextureReadWrite.Linear);
        worldPosTexTemp.name = "WorldPosTexTempRenderTexture";
        ...
        worldTangentTex.name = "WorldTangentTexRenderTexture";
        worldTangentTex.Create();
        worldBinormalTex =
            new RenderTexture(sizeX, sizeY, 0, RenderTextureFormat.ARGB32, RenderTextureReadWrite.Linear);
        worldBinormalTex.name = "WorldBinormalTexRenderTexture";
        ...
        scoreTex = new RenderTexture(sizeX / 8, sizeY / 8, 0, RenderTextureFormat.ARGBHalf,
